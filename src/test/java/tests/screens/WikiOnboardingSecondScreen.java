...
public class WikiOnboardingSecondScreen {
    ...
    public WikiOnboardingSecondScreen clickContinueButton() {
        continueButton.click();
        return this;
    }

    @Step("Click on Get started button")
    public WikiOnboardingSecondScreen clickGetStartedButton() {
        getStartedButton.click();
        return this;
    }

    @Step("Check title appears")
    public WikiOnboardingSecondScreen checkPageTitleIsDisplayed(String title) {
