...
public class WikiOnboardingThirdScreen {
    ...
    public WikiOnboardingThirdScreen clickContinueButton() {
        continueButton.click();
        return this;
    }

    @Step("Click on Get started button")
    public WikiOnboardingThirdScreen clickGetStartedButton() {
        getStartedButton.click();
        return this;
    }

    @Step("Check title appears")
    public WikiOnboardingThirdScreen checkPageTitleIsDisplayed(String title) {
